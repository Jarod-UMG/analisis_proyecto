...
CREATE TABLE `compras` (
  ...
  KEY `fk_compras_clientes_idx` (`id_cliente`),
  KEY `fk_compras_pagos_idx` (`id_pago`),
  CONSTRAINT `fk_compras_clientes` FOREIGN KEY (`id_cliente`) REFERENCES `clientes` (`id_cliente`),
  CONSTRAINT `fk_compras_pagos` FOREIGN KEY (`id_pago`) REFERENCES `pagos` (`id_pago`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `detalles_compra` (
  ...
  `cantida` int DEFAULT NULL,
  `precio` double DEFAULT NULL,
  PRIMARY KEY (`id_dcompra`),
  KEY `fk_detalles_productos_idx` (`id_producto`),
  KEY `fk_detalles_compras_idx` (`id_compra`),
  CONSTRAINT `fk_detalles_compras` FOREIGN KEY (`id_compra`) REFERENCES `compras` (`id_compra`),
...
-- Dump completed on 2022-10-26 22:16:29
